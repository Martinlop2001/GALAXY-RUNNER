...
class BaseScene(ABC):
    ...
    def draw_button(self, screen, text, font, color, bg_color, x, y, width, height, center=False):
        """Dibujar un botón"""
        ...
        if center:
            self.draw_text(screen, text, font, color, x + width//2, y + height//2, center=True)
        else:
